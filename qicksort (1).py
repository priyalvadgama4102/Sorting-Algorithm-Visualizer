...
def quick_sort(data, head, tail, drawData, timeTick):
    if head < tail:
        partationIdx = partition(data, head, tail, drawData, timeTick)

        quick_sort(data, head, partationIdx - 1, drawData, timeTick)

        quick_sort(data, partationIdx + 1, tail, drawData, timeTick)
